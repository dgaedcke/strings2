...
private let associatedValueKey = "com.pathoz.extra.Observing"

//public extension NSObject
//{
//	func startObserving(name: String, object: AnyObject? = nil, queue: OperationQueue? = nil, usingBlock block: @escaping (NSNotification) -> Void) {
//		
//		let nc = NotificationCenter.default
//		setAssociatedValue(value: nc.addObserverForName(NSNotification.Name(rawValue: name), object: object, queue: queue, usingBlock: block)
//		, forKey: "\(associatedValueKey).\(name).\(object?.hashValue ?? 0)")
//	}
//	
//	func stopObserving(name: String, object: AnyObject? = nil) {
//		setAssociatedValue(value: nil, forKey: "\(associatedValueKey).\(name).\(object?.hashValue ?? 0)")
//	}
//}
